...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void PoblarControlers()
        {
            ...
            // Correccion: cambiar 'contrasenia' por 'contrasena' porque el atributo en Usuarios esta asi
        ...
        private void BttnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            // Correccion: agregar el metodo para actualizar los datos despues de cambiar contrasena
