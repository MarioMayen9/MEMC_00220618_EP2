...
namespace Preparcial.Vista
{
    public partial class FrmMain : Form
    {
        ...
        {
            // Correccion: agregar que muestre el nombre cuando seleccione la tab1
            // para que el 'else' no aplique dos veces cuando se selecciona una tab que no puede ver el user actual
            if (tabControl1.SelectedTab.Name.Equals("generalTab"))
                label1.Text = "Bienvenido " + u.NombreUsuario;
        ...
        {
            // Correccion: alinear a la posicion correcta
            Application.Exit();
        }
    }
}